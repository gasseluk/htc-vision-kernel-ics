 ...
 * which was adaptated to 2.6.32 kernel by mdeejay                    
 * 
 * requires to add
 ...
 */
#define DEFAULT_UP_MIN_FREQ 1399999
 ...
 */
#define DEFAULT_SLEEP_WAKEUP_FREQ 1305600
...
MODULE_DESCRIPTION ("'cpufreq_minmax' - A smart cpufreq governor optimized for the leo!");
MODULE_LICENSE ("GPL");
